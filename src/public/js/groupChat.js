...
function cancelCreateGroup() {
  $("#btn-cancel-create-group-chat").bind("click", function () {
...
function callCreateGroupChat() {
  $("#btn-create-group-chat").unbind("click").on("click", function () {
    ...
    if (countUsers.length < 2) {
      alertify.notify("Vui lòng chọn thêm bạn bè để thêm vào nhóm, tối thiếu 2 người", "error", 7);
      return false;
    }
    ...
    if (!regexGroupChatName.test(groupChatName) || groupChatName.length < 5 || groupChatName.length > 30) {
      ...
      alertify.notify("Vui lòng nhập tên cuộc trò chuyện, giới hạn 5-30 ký tự và không chứa các kí tự đặt biệt", "error", 7);
      return false;
    }
    ...
    Swal.fire({
      ...
      $.post("/group-chat/add-new", {
        ...
        $("#btn-cancel-create-group-chat").click();
        ...
        //Step 04: call function changScreenChat 
        changeScreenChat();
