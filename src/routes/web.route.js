...
import { home, auth, user, contact, notification, message, groupChat } from "./../controllers/controller";
import { authValid, userValid, contactValid, messageValid, groupChatValid } from "../validation/validation";
